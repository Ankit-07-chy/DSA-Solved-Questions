...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/prefix-to-infix-conversion/1)

## Solved On
01 Jul 2026 at 04:11 pm

<h2><a href="https://www.geeksforgeeks.org/problems/prefix-to-infix-conversion/1">Prefix to Infix Conversion</a></h2><h3>Difficulty Level: Medium</h3><hr><p dir="ltr"><span style="font-size: 18px;">You are given a string <strong>S</strong>&nbsp;of size <strong>N</strong> that represents the prefix form of a valid mathematical expression. The string <strong>S</strong> contains only lowercase and uppercase alphabets as operands and the operators are +, -, *, /, %, and ^.Convert it to its infix form.</span></p>
