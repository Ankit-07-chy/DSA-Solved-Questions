...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/reverse-a-doubly-linked-list/1)

## Solved On
14 Jul 2026 at 05:52 pm

<h2><a href="https://www.geeksforgeeks.org/problems/reverse-a-doubly-linked-list/1">Reverse a Doubly Linked List</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given the <strong>head </strong>of a <strong>doubly linked list</strong>. You have to <strong>reverse </strong>the doubly linked list and return its <strong>head</strong>.<br></span></p>
